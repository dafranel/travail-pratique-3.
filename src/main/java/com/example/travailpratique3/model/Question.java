 ...
 * - un contour noir.
 */
public class Question extends Circle {
    ...
    private com.example.travailpratique3.model.Question type;
     ...
     */
    public Question(double x, double y, double rayon, com.example.travailpratique3.model.Question type, Image image) {
        super(x, y, rayon);
     ...
     * @return type actuel
     */
    public com.example.travailpratique3.model.Question getType() {
        return type;
    }
     ...
     */
    public void setType(com.example.travailpratique3.model.Question type, Image image) {
        this.type = type;
        setFill(new ImagePattern(image));
    }
}